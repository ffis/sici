...
window.Feedback.Screenshot.prototype.start = function( modal, modalHeader, modalFooter, nextButton ) {
    ...
    if ( this.h2cDone ) {
        ...
        blackoutButton = element("a", "Ocultar"),
        highlightButton = element("a", "Destacar"),
        previousElement;
        ...
        this.dom.appendChild( element("p", "Destaque la parte importante de la pantalla a fin de que quede destacada en la captura de pantalla.") );
